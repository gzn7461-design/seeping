...
export async function PUT(
  ...
  try {
    ...
    const { stock_code, stock_name, negative_threshold, wecom_webhook, alert_types, check_interval, daily_push_enabled, daily_push_time, check_negative, check_sensitive } = body;
    ...
    const { data, error } = await supabase
      ...
      .update({
        ...
        check_negative: check_negative || 'true',
        check_sensitive: check_sensitive || 'true',
        wecom_webhook,
