...
export default function MonitorPage() {
  ...
  const handleExcelUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      formData.append("stock_code", String(uploadStockCode || ""));
      formData.append("stock_name", String(uploadStockCode ? stocks.find(s => s.stock_code === uploadStockCode)?.stock_name || "" : ""));
